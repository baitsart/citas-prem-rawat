...
# Base de datos local o de respaldo para citas
CITAS_MEMORIA = [
    (
...
# Estado global simple en memoria para la sesión interactiva
STATE = {"current_image": None, "current_quote": None, "current_author": None}

# ============================================================
# FUENTES DE IMÁGENES Y CITAS
# ============================================================
...
def fetch_wallhaven():
    ...
    raise RuntimeError("Sin resultados en Wallhaven")
...
def get_new_background():
    for provider in [fetch_wallhaven, fetch_bing]:
        try:
            img_data = provider()
...
# ============================================================
# COMPOSICIÓN DE IMAGEN CON PILLOW
# ============================================================


def generate_composite_image(bg_image, quote_text, author_text):
    # Obtener color promedio del fondo para adaptar el cuadro
...
def render_image():
    if STATE["current_image"] is None:
        STATE["current_image"] = get_new_background()
...
def index():
    ...
    <head>
        ...
        <title>Generador de Citas & Wallpapers</title>
        <style>
